<x-main>
    ...
    <h1 class="text-center">{{__('ui.annunci-presenti')}}: {{$category->name}}</h1>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <p>{{__('ui.che-ne-dici')}}<a href="{{route('announcement.create')}}" class="btn btn-warning mx-2">{{__('ui.crea')}}</a></p>
        @endforelse
        </div>
